...
def get_sales_data():
    ...
    """
    while True:
        print("Please enter sales data from laste market.")
...
def validate_data(values):
    ...
    try:
        ...
        if len(values) != 6:
            raise ValueError(
                print(f"Exactally 6 values are required, you provided {len(values)}")
            )
...
print("Make the following number of sanwichs for market:\n")
print(stock_values)
